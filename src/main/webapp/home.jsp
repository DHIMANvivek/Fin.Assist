...
<body>
	...
	<h1 style="color: blue;">
		<center>↓ Enter Your Products Here ↓</center>
	</h1>
...
.button5 {
	...
	border: 2px solid #555555;
		...
		<a href="viewproducts.jsp"><p style="color: red;">
			<h3>
		...
		<form action="addproducts.jsp" method="get">
			<div class="form-group">
				...
				<input type="text" placeholder="Enter Item" id="email"
					name="txtItem">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="number">Enter Price</label> <br>
